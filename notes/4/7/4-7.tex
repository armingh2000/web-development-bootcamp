...
\vspace{-3em}
\begin{tcolorbox}
\Huge\sffamily The Anatomy of CSS Syntax
\end{tcolorbox}
\vspace{-3em}
}
...
\cornell{CSS Syntax}{selector \{ property:value;\} WHO? WHAT? HOW?}

\cornell[{BEST PRACTICE}{In css, always add properties in alphabetical order to make it easy to debug it later}]
