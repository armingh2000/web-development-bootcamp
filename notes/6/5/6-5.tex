...
\vspace{-3em}
\begin{tcolorbox}
\Huge\sffamily Setting Up Our New Project
\end{tcolorbox}
\vspace{-3em}
}
...
\cornell[{TIP}{for some of bootstrap functionalities to work, we need to add the js and jquery code from bootstrap to our site}]
