...
\vspace{-3em}
\begin{tcolorbox}
\Huge\sffamily HTML Image Element
\end{tcolorbox}
\vspace{-3em}
}
...
\cornell{Image tag}{img tag, self closing elemnet, src="", alt=""}

\cornell[{TIP}{alt attribute is used for search engines and also when the image can't be loaded, the alternative text is shown}]
