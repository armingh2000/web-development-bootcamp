...
\cornell{form tag}{attribs: class, action, method}

\cornell[{TIP}{form tags in html are usefull only when used with both label and input tags. It has nothing by itself}]
