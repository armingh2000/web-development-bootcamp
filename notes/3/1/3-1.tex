...
\cornell{Table tag}{table tag, td table data, tr table row, thead table heading, tbody table body, tfoot table footer, th table head data (bold default)}

\cornell[{TIP}{Do not use attributes for styling in html; e.g. border in table. These attributes should be used only in css for designing the web page}]
\end{document}
