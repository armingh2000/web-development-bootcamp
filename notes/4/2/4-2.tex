...
\cornell{css style codes}{background-color:...;}

\cornell[{TIP}{hex code colors are always with \#}]

\cornell{Inline Css}{Is a kind of css code that is used just inside every tag. Because it should be repeated for many times, its better to use internal css instead}
