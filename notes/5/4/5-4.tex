...
\vspace{-3em}
\begin{tcolorbox}
\Huge\sffamily The Box Model of Website Styling
\end{tcolorbox}
\vspace{-3em}
}
...
\cornell[{TIP}{Every element in html is a box}]

\cornell[{TIP}{Background color is always behind background picture}]
