...
\vspace{-3em}
\begin{tcolorbox}
\Huge\sffamily Forms in Practice - Create a Contace Me Form
\end{tcolorbox}
\vspace{-3em}
}
...
\cornell{textarea tag}{Used for getting long inputs (messages), att: name, rows, cols}

\cornell[{TIP}{form action att, can be set to mailto:... for mailing}]

\cornell[{TIP}{name field of inputs, define inputs while they're being posted}]
