...
\vspace{-3em}
\begin{tcolorbox}
\Huge\sffamily Using HTML Tables for Layouts
\end{tcolorbox}
\vspace{-3em}
}
...
\cornell[{TIP}{Without knowing css, html still can be used to design the layout of the page; but it's not recommended though}]
