...
\vspace{-3em}
\begin{tcolorbox}
\Huge\sffamily The Dark Art of Centering Elements With CSS
\end{tcolorbox}
\vspace{-3em}
}
...
\cornell{text-align}{makes all of the elements of the parent element to centeralizei, except the ones that have width att}

\cornell{margin: auto}{centers the element either vertically or horizontally}
