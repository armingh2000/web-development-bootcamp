...
\cornell[{TIP}{Divs don't do anything, unless it is with css}]

\cornell[{TIP}{Div = contact devision element}]

\cornell[{TIP}{Always be aware of default css values}]
