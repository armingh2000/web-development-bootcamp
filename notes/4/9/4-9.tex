...
\cornell[{TIP}{Id and Class have higher priority than tag selector}]

\cornell[{TIP}{Id should be uniquei in each page. But class can be redundant.}]

\cornell[{TIP}{Any html element can have more than 1 class, but only 1 id\\
class="class1 class2" class2 > class1}]

\cornell[{TIP}{Ids are better not to use}]

\cornell{psuedo class}{are css properties that start with : . The most often usage is in :hover}
